...
import { getNextProjectSortOrder } from "@/lib/content/admin";
...
export default async function NewAdminProjectPage() {
  ...
  const nextSortOrder = await getNextProjectSortOrder(access.client);
  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-10">
      ...
      <ProjectEditor defaultSortOrder={nextSortOrder} />
    </main>
  );
}
